...
IMAGE_DESC_PROMPT = """# Goals

请对用户提供的图片进行客观描述，准确提取并列出图片中的关键对象。

# Constrains

- 你应当描述图片中的物品、实体、文本等具体对象，不要输出形容、评价等主观性内容。
- 描述应保持客观，包括图片的整体场景描述和关键对象的列举。
- 提取的关键对象应具有明确的视觉特征和重要性。
- 仅基于图片中可见的内容进行分析，确保描述的准确性和完整性，避免主观臆断或情感色彩。
- 如果图片中有文字，可以尝试识别和复述文字内容。"""
